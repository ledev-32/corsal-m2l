...
public class premiereFen extends JFrame {
    ...
    public premiereFen() {
        ...
        textArea.setBounds(50, 280, 380, 120);
        contentPane.add(textArea);
        afficherAdherents();
        
        JButton btnRecherche = new JButton("Recherche et consultation");
        btnRecherche.setBounds(140, 220, 200, 30);
    ...
    class FenetreRecherche extends JFrame {
        public FenetreRecherche() {
            setTitle("Recherche et Consultation");
            setSize(400, 200);
            setLocationRelativeTo(null);
            setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            add(new JLabel("Interface de recherche en cours de développement...", SwingConstants.CENTER));
        }
    }
